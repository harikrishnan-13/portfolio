        ...
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <h2 className="text-lg sm:text-xl font-semibold flex items-center gap-2">
              <FaBriefcase className="text-blue-400 text-sm sm:text-base" />
              {exp.role}
            </h2>

            {/* Company */}
            <p className="text-blue-400 font-medium mt-1 flex items-center gap-2 text-sm sm:text-base">
            ...
            <ul className="mt-4 space-y-2">
              {exp.achievements.map((item, i) => (
                ...
                >
                  <FaCheckCircle className="text-green-400 mt-1 text-xs sm:text-sm" />
                  <span>{item}</span>
                </motion.li>
              ))}
            </ul>
            ...
            {/* Bottom Highlight */}
            <motion.div
              className="mt-4 text-xs sm:text-sm text-blue-400 flex items-center gap-2"
